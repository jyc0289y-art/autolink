...
| 문서 | 경로 | 작성일 | 설명 |
|------|------|--------|------|
| **사업계획서 v1.1** ⭐ | [`business-plan_automation-dashboard-service.md`](../business-plan_automation-dashboard-service.md) | 2026-04-29 22:45 | 4영역 우산 메시지, 운영비 투명성(§3.6), 시그니처 6케이스 |
...
| **사용자 액션 가이드** | [`docs/20260429_224059_사용자_액션_가이드.md`](20260429_224059_사용자_액션_가이드.md) | 2026-04-29 22:40:59 | 진영 대표 직접 처리 작업 단계별 절차 (ACT-002/006/007/008) |
| **운영비 가이드** | [`docs/20260429_224447_운영비_가이드.md`](20260429_224447_운영비_가이드.md) | 2026-04-29 22:44:47 | 외부 API 비용 명세 + 분쟁 예방 + 사장님 안내 양식 |
